...
//            }
    ...
    <body id="edit-profile">
        ...
        <div id="container"><div id="container-inner">
                ...
                <h1>Edit Product</h1>
                <form name="input" action="editProduct" method="post" >
                    <%             Product p = (Product) request.getSession().getAttribute("editedProduct");
            ProductDetail productDetail = (ProductDetail) request.getSession().getAttribute("editedProductDetail");%>
                    <fieldset>
                        <div>
                            <label for="name_first">Photo directory: </label>
                            <input type="text" name="image" id="name_first"  value="${p.getImage()}"/>
                        </div>
                        <!-- Your first name -->
                        <!--                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name_last" value="${p.getName()}"/>
                        </div>

                        <div>
                            <label for="name_first">Price: </label>
                            <input type="text" name="price" id="name_first" value="${p.getPrice()}"/>
                        </div>

                        <!-- About you -->
                        <div>
                            <label for="about_you">Description: </label>
                            <textarea name="description" id="about_you" rows="10" cols="5" value="${p.getDescription()}"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description_detail" id="about_you" rows="10" cols="5" value="${p.getDescriptionDetail()}"></textarea>
                        </div>
                        <div>
                            <label for="name_first">Guaranty </label>
                            <input type="text" name="guaranty" id="name_first" value="${productDetail.getGuaranty()}"/>
                        </div>
                        <div>
                            <label for="name_first">Accessories: </label>
                            <input type="text" name="accessories" id="name_first" value="${productDetail.getAccessories()}"/>
                        </div>
